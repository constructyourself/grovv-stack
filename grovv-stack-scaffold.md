...
4. **Work through Steps 2-8 sequentially**, pausing to confirm direction as needed. Step 7 designs the project-specific agent team (harness) after the skills repository exists.
...
- [ ] `docs/prompts/` contains all four prompt documents (skills-builder, team-design, tech-spec, readme-generator)
